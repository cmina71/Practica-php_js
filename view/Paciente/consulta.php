                ...
                foreach ($pacientes as $pac){
                    echo "<tr>";
                       ...
                       /*  echo "<td>".$pac['pac_direccion']."</td>";
                        ...
                        //Ver Detalle
                        ?><td><div class='page'><a href='<?php echo getUrl("Paciente", "Paciente", "verDetallee", 
                        array("pac_id"=>$pac['pac_id'])); ?>' id='<?php echo $id = $pac['pac_id'];?>'><button class='btn btn-primary' id="<?php $btn++; ?>">Ver más...</button></a></div></td><?php

                        //Boton consultar historia
                        echo "<td> <a href='".getUrl("Historia", "Historia", "consulta", 
                                array("pac_id"=>$pac['pac_id']))."'>
                                <button class='btn btn-primary'>Consultar Historia</button></a></td>";
